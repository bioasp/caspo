...
class DotWriterAdapter(object):
    NODES_ATTR = {
        'DEFAULT':   {'color': 'black', 'fillcolor': 'white', 'style': 'filled, bold', 'fontname': 'Helvetica', 
                      'fontsize': 18, 'fixedsize': True, 'width': 1, 'height': 0.6, 'shape': 'ellipse'},
...
class StrategySet2DotWriter(object):
